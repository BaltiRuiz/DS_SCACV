...
public class PanelBotones extends JPanel implements Observador {
	...
	public JButton getBotonMantener(){
	...
	public JButton getBotonRepostar(){
		return BotonRepostar ;
	}
	
	public JButton getBotonRestear(){
		return BotonRestear ;
	}
	
	public JButton getBotonMecanico1(){
		return botonMecanico1 ;
	}
	
	public JButton getBotonMecanico2(){
		return botonMecanico2 ;
	}
	
	public JButton getBotonMecanico3(){
		return botonMecanico3 ;
	}
